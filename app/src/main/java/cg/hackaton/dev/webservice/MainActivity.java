...
import cg.hackaton.dev.webservice.api.Client;
import cg.hackaton.dev.webservice.api.Service;
        ...
        try {
            ...
            call.enqueue(new Callback<AlbumsResponse>() {
                ...
                public void onFailure(Call<AlbumsResponse> call, Throwable t) {
                    ...
                    Toast.makeText(MainActivity.this, "Erreur pendant l'affichage des données", Toast.LENGTH_SHORT).show();
                    pd.hide();
                }
            });
        }catch (Exception e){
